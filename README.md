...
**Cammate**는 촬영자의 화면을 실시간으로 공유하여, 피사체가 원하는 구도와 각도로 찍히고 있는지 직접 확인할 수 있도록 합니다.
...
| 네트워크 | STUN Server, TURN Server |

---

## 🏗 아키텍처

<img width="833" height="646" alt="스크린샷(52)" src="https://github.com/user-attachments/assets/398f7d5a-a391-45d9-b277-f477cfc5e84f" />
...
|------|------|
| **WebRTC 화면 공유 구현** | 본인 |
| WebSocket 채팅 구현 | 팀원 A |
| UI 개발 | 본인 + 팀원 A |
| 백엔드 (Spring Boot, MySQL) | 팀원 B |
